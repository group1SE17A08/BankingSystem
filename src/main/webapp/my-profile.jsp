...
<body>
						...
						<div class="card-body text-center">
							...
							<form method="post">
								...
								<div class="d-flex justify-content-center mb-2">
									<button type="button" id="changeButton" class="btn btn-danger">Request
										a Personal Information Change</button>
								</div>
					...
					<form method="post">
						...
						<c:if test="${not empty sessionScope.requestSuccess }">
							<h5 style="color: green">
								Successful Request! Please wait the admin to approve. Click <a
									href="homepage">here</a> to go to homepage
							</h5>
							<%
	...
	<script>
		function changeParagraphsToInputs() {
			...
			var input2 = cardBodies[1].children[6].children[1].children[0];
			input2.pattern = "^\\d{4}\\-(0[1-9]|1[012])\\-(0[1-9]|[12][0-9]|3[01])$";
			input2.title = "Please input with format: yyyy-mm-dd";
