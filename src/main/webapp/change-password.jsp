	...
	<div class="mainDiv">
		<div class="cardStyle">
			<form action="/BankingSystem/change-password" method="post" name="signupForm" id="signupForm">
				...
				<div class="inputDiv">
					<label class="inputLabel" for="password">New Password</label> <input pattern="^.{8,}$"
								title="Password must be more than 8 letters"
						type="password" id="password" name="newPass" required>
				</div>

				<div class="inputDiv">
					<label class="inputLabel" for="confirmPassword">Confirm
						Password</label> <input pattern="^.{8,}$"
								title="Password must be more than 8 letters" type="password" id="confirmPass"
						name="confirmPass">
				</div>
