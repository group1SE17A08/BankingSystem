        ...
        <ul class="navbar-nav ms-auto d-flex flex-row">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
              ...
              <li>
                <a class="dropdown-item" href="#"><i class="poland flag"></i>Polish</a>
              </li>
              <li>
                <a class="dropdown-item" href="#"><i class="china flag"></i>Chinese</a>
              </li>
              <li>
                <a class="dropdown-item" href="#"><i class="japan flag"></i>Japanese</a>
              </li>
              <li>
                <a class="dropdown-item" href="#"><i class="germany flag"></i>German</a>
              </li>
              <li>
                <a class="dropdown-item" href="#"><i class="france flag"></i>French</a>
              </li>
              <li>
                <a class="dropdown-item" href="#"><i class="spain flag"></i>Spanish</a>
              </li>
              <li>
                <a class="dropdown-item" href="#"><i class="russia flag"></i>Russian</a>
              </li>
              <li>
                <a class="dropdown-item" href="#"><i class="portugal flag"></i>Portuguese</a>
              </li>
            </ul>
          </li>
